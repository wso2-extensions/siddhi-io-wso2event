...
package io.siddhi.extension.io.wso2event.test.osgi;

import io.siddhi.extension.io.wso2event.test.osgi.util.DataPublisherTestUtil;
    ...
    public Option[] createConfiguration() {
        return new Option[]{
                ...
                copyOSGiLibBundle(maven().artifactId("siddhi-io-wso2event").
                        groupId("io.siddhi.extension.io.wso2event")
                        .versionAsInProject()),
